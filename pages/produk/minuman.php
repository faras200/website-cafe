...
$query_makanan = $koneksi->selectAll("SELECT * FROM produk WHERE kategori_produk = 'cofee'  ");
...
$query_makanan = $koneksi->selectAll("SELECT * FROM produk WHERE kategori_produk  = 'softdrink' ");
        foreach($query_makanan as $row): ?>
      <div class="card col-md-4" style="box-sizing:border-box" style="margin-left:5px !important; margin-right:5px !important;">
                <img class="card-img-top" src="admin/img/produk/<?=$row['foto_produk']?>" alt="Card image cap">
                <div class="card-body">
...
$query_makanan = $koneksi->selectAll("SELECT * FROM produk WHERE kategori_produk  = 'non_coffe' ");
        foreach($query_makanan as $row): ?>
      <div class="card col-md-4" style="box-sizing:border-box" style="margin-left:5px !important; margin-right:5px !important;">
                <img class="card-img-top" src="admin/img/produk/<?=$row['foto_produk']?>" alt="Card image cap">
                <div class="card-body">
