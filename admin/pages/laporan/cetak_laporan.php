...
<hr style="margin-top:-10px; border:2px solid black">
    <h1 style="margin-top:-10px;">Laporan Transaksi Hari Ini</h1>
    <h2 style="text-align:center;"> Tanggal '. $tgl .'</h2>
    <table class="table1">
    <tr>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Laporan Transaksi Harian.pdf', \Mpdf\Output\Destination::INLINE);
