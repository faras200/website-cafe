...
if(isset($_POST['login'])){
    $admin-> login_admin($_POST['username'], $_POST['password']) ;
}
              ...
              <div class="card card-login card-plain">
                ...
                <div class="card-body ">
                  ...
                  <div class="input-group no-border form-control-lg">
                    ...
                    <input type="text" class="form-control contoh1" name="username" style="color: white !important;" placeholder="Username" >
                  </div>

                  <div class="input-group no-border form-control-lg">
                    <div class="input-group-prepend">
                      <div class="input-group-text">
                        <i class="now-ui-icons text_caps-small" style="color: white !important;" ></i>
                      </div>
                    </div>
                    <input type="password" placeholder="Password" name="password" style="color: white !important;"  class="form-control contoh1">
                  </div>
                </div>

                <div class="card-footer ">
                  <button type="submit" name="login" class="btn btn-primary btn-round btn-lg btn-block mb-3">LOGIN</button>
                </div>
